...
$ontext
Time-stamp:     <2021-05-04 13:51:12 st>
...
*       部門数
$setglobal sec_num 185

$setglobal gdx_file sample_data_3
$setglobal temp_file temp_3
$setglobal inv_gdx_file inverse_data_3
$setglobal excel_range IO_ex_3!B4:GG191
...
display "@@ シナリオ2: ";
$ontext
建設業（i128）に対する最終需要額が5000億円増加

$offtext
*       最終需要の額
v_fd_new(i) = v_fd_org(i);
v_fd_new("i128") = v_fd_org("i128") + 500;

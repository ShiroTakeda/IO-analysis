...
$ontext
Time-stamp:     <2021-05-04 13:51:20 st>
First-written:  <2021/05/02>

$offtext

*       excel -> gdx の変換をするときには 1 を設定。一度作成したら 0 にすればよい。
$setglobal fl_data_remake 0

*       部門数
$setglobal sec_num 13

$setglobal gdx_file sample_data_2
$setglobal temp_file temp_2
$setglobal inv_gdx_file inverse_data_2
$setglobal excel_range IO_ex_2!B4:Q19
